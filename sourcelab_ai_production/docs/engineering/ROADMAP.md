...
- [x] Real embedding backend.
- [x] OpenAI-compatible embedding backend (vLLM, SGLang, LiteLLM, NIM).
- [x] Qdrant or pgvector (local-first stubs with clear setup instructions).
- [x] BM25 keyword search.
- [x] Hybrid search.
- [x] Reranker (TrustTier, RRF, LengthNormalized with factory + config integration).
- [x] Compression adapters (int8, fp16, binary, product quantization).
...
- [x] More domain packs (ML safety, cloud security) beyond PQC v1 and ai_safety_v1.
- [x] Dashboard Evals tab for viewing golden eval results.
- [x] 657 tests passing.
